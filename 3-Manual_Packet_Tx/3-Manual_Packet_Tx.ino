...
Message msgBuffer[BUFFER_SIZE], msg;
uint8_t bufferIndex = 0;
char packetString[BUFFER_SIZE * sizeof(Message) + 1];
...
void txCallback(){
  ...
  packPacket();
  rs = e22ttl.sendFixedMessage(E22_DEST_ADDH, E22_DEST_ADDL, E22_CONFIG_CHAN, packet, sizeof(Message) * bufferIndex);
